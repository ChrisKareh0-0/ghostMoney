            ...
            <div className="card" style={{ marginTop: '2rem' }}>
                ...
                <div style={{ padding: '1rem' }}>
                    <p className="text-muted" style={{ marginBottom: '1rem' }}>
                        Since you are running in Browser Mode, your data is stored in your browser's local storage.
                        It is recommended to <strong>Export</strong> your data regularly to keep a safe backup file on your computer.
                    </p>
                    <div style={{ display: 'flex', gap: '1rem' }}>
                        <button
                            onClick={async () => {
                                const result = await window.electronAPI.exportToExcel('db', null);
                                if (result.success) alert(result.message);
                            }}
                            className="btn btn-primary"
                        >
                            ⬇️ Export Database Backup
                        </button>
                        ...
                        <input
                            ...
                            accept=".json"
                            style={{ display: 'none' }}
                            onChange={(e) => window.importDatabase(e.target)}
                        />
                    </div>
                </div>
            </div>
